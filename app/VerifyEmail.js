        ...
        <SafeAreaView style={stylesheet.container}>
            <View style={stylesheet.body}>
                ...
                <View style={stylesheet.titleView}>
                    <Text style={stylesheet.title}>Verifying your email</Text>
                </View>
                <Text style={stylesheet.text}>Enter the 6-digit code we sent to
                    <Text style={stylesheet.textMobile}>{" " + getEmail + " "}
                ...
                <View style={stylesheet.bodyMain}>
                    <View style={stylesheet.bodySub1}>
                        ...
                        }} disabled={status == "Running" ? true : false}> Resend code? <Text style={stylesheet.text}>{time}</Text></Text>
